...
//  OpenBCI'nin Arduino ile çalýþan EEG cihazý, sensörlerden gelen sinyalleri 
//  okur ve bu sinyalleri bir bilgisayara veya baþka bir cihaza aktarýr. 
//  Bu verileri okumak ve grafik olarak çizmek için birkaç yol vardýr. 
//  C# kullanarak, öncelikle Arduino'ya baðlý bir seri baðlantý açmanýz gerekecektir.

//  Aþaðýdaki kaynaklar, C# ve Arduino arasýnda seri baðlantý kurmak 
//  ve veri okumak için farklý yaklaþýmlarý göstermektedir:
...
//  Seri baðlantýyý baþarýlý bir þekilde kurduktan sonra, 
//  sensörlerden gelen verileri okumak için bir döngü kullanabiliriz. 
//  Bu verileri grafik olarak çizmek için C#'da çeþitli 
//  grafik kütüphaneleri mevcuttur. 
//  Bazý popüler grafik kütüphaneleri þunlardýr:
...
//  çok düþük frekanslarda olduðu için, veri iþleme teknikleri ve 
//  filtreleme yöntemleri kullanmamýz gerekebilir.
